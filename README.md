...
| **The next job** | [ORIENTATION §7e](docs/superpowers/ORIENTATION.md) names it and says how to run it; the current plan's sittings table says how far it has got. This row deliberately states neither (2026-09-24): the job lives in those two places only. |
