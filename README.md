...
**1742 tests with no Docker, and 200 more that need a daemon** — the Docker tier skips nothing, since P4c Task 5 gave the Docker driver the fixtures for the driver contract's continuity block, and **the unit tier's one skipped test is GONE**: it was the production gate's positive control, and P6a's Task 14 un-skipped it by building the last blocking item it was waiting for. *(Re-measured at the close of the sitting that fixed P6b's F10, 2026-09-24 — the console's *Sign out* now ends the IdP session: 1742, up 19, and 200, up 2 — a console sign-out against the real IdP and an app's through the blueprint's skeleton. Each earlier sitting's movement is in its plan record.)* See
