...
- **What a person can DO there today** (P5c Tasks 5 to 8): sign in with CWL and see who the
  ...
  **Deploy to production is there and is refused**, with §13's checklist rendered from the
  ...
  guards promoting a release — so the checklist a person reads on that screen comes from the
  read rather than from the refusal until the console learns to step up (Task 18's). **§26's QUEUE AND D24's TOKENS ARE BOTH SCREENS NOW.** On a project's *Tokens* tab a person
