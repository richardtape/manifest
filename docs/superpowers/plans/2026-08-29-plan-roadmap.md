...
reserved as slugs. All five are applied to the spec (`1d88846`).**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   **the caller for all of it**: `deployRelease` serialized per environment, and boot
   ...
   `make demo-redeploy` 21 of 21 green, up from a baseline of 10).** ← **Next: write P5a** (P5 became P5a, P5b and P5c on 2026-09-16). It waited for P4b to execute, because P4b's Tasks 8–15 were changing the deploy
