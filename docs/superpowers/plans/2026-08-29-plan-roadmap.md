...
all 16 tasks, finished 2026-09-15. P4c — zero-downtime redeploys — IS THE CURRENT WORK, AND UNWRITTEN.**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   **P4b was then written on 2026-09-07 as well, at Rich's request** —
   ...
   ← **Then P4c, before P5 (Rich, 2026-09-14): zero-downtime redeploys — THE CURRENT WORK, AND
   UNWRITTEN.** It waited for P4b to execute, because P4b's Tasks 8–15 were changing the deploy
