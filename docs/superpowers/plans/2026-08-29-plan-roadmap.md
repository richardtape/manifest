...
sittings 1 to 6 — Tasks 1 to 10 — are done, and SITTING 7 (Tasks 11 and 12) IS THE CURRENT WORK.**
...
| **P4b** | The LiteLLM client with `allowed_routes`, the classification-gated catalogue (D17), key lifecycle, the blueprint's AI wiring, `WS /projects/:id/events`, heuristic redaction, incidents | the proof app's LLM answer | **WRITTEN 2026-09-07**, 16 tasks; **10 executed by 2026-09-14** (sittings 1–6 of ten). [`2026-09-07-p4b-ai-events-streaming-incidents.md`](./2026-09-07-p4b-ai-events-streaming-incidents.md). Writing it measured **ten more facts**, one of which is a §10 requirement that **cannot be implemented at LiteLLM 1.98.0** |
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   2026-09-09 — and P4b is PART-EXECUTED: sittings 1–6 (Tasks 1–10) done by 2026-09-14,
   6 tasks remaining. Continue P4b at Task 11.**
6. **Start the external track once the local proof of concept works end to end.**
   **Changed 2026-09-05, Rich's call.** This step previously said *"start now, in
   ...
   for a missed one. Until then, do not re-raise it.
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   2026-09-09.** ← **P4b IS NOW THE CURRENT WORK, AT TASK 11** (sittings 1–6
   done, 2026-09-14).
   ...
   **Then P4c, before P5 (Rich, 2026-09-14): zero-downtime redeploys**, written once P4b has
   executed, because P4b's Tasks 8–15 are still changing the deploy path it replaces. The plan
   table's P4c row is its brief — including the five things it must settle, first among them a
   measured baseline.
