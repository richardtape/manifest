...
sittings 1 to 7 — Tasks 1 to 12 — are done, and SITTING 8 (Task 13) IS THE CURRENT WORK.**
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   2026-09-09 — and P4b is PART-EXECUTED: sittings 1–7 (Tasks 1–12) done by 2026-09-14,
   4 tasks remaining. Continue P4b at Task 13.**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   2026-09-09.** ← **P4b IS NOW THE CURRENT WORK, AT TASK 13** (sittings 1–7
   done, 2026-09-14).
