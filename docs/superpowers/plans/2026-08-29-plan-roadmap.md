...
all 16 tasks, finished 2026-09-15. P4c — zero-downtime redeploys — IS WRITTEN (2026-09-15) AND BEING EXECUTED: 11 tasks in eight agreed sittings, SITTINGS 1 TO 7 ARE DONE (1–6 on 2026-09-15, 13 findings, 4, 7, 6, 9 and 10; 7 on 2026-09-16, 9 findings) and SITTING 8 (TASK 11, THE ACCEPTANCE, ALONE AND LAST) IS NEXT. Since sitting 6 the platform redeploys itself without interrupting anybody, and since sitting 7 nobody is signed out by it either: `make demo-redeploy` is 21 of 21 green.**
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   WRITTEN and being executed — sittings 1 to 7 done, 2026-09-15 and 2026-09-16 (step 7).**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   **P4b was then written on 2026-09-07 as well, at Rich's request** —
   ...
   11 tasks in eight agreed sittings, AND BEING EXECUTED: sittings 1 to 7 are done
   ...
   **the caller for all of it**: `deployRelease` serialized per environment, and boot
   ...
   `make demo-redeploy` is 21 of 21 green, up from a baseline of 10), and
   sitting 8 (Task 11, the acceptance, alone and last) is next.** It waited for P4b to execute, because P4b's Tasks 8–15 were changing the deploy
