...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   **the caller for all of it**: `deployRelease` serialized per environment, and boot
   ...
   `make demo-redeploy` 21 of 21 green, up from a baseline of 10).** ← **Next: write P5.** It waited for P4b to execute, because P4b's Tasks 8–15 were changing the deploy
