...
### D5's driver 2 — the GitHub source driver. PLACED AFTER P6b, 2026-09-19 — **WRITTEN 2026-09-24: [`2026-09-24-d5-github-source-driver.md`](./2026-09-24-d5-github-source-driver.md), 15 tasks in Rich's eight sittings. SITTING 1 — THE MEASUREMENTS — SITTING 2 — THE BUILD PATH AND THE KEY'S CUSTODY — AND SITTING 3 — THE FAKE, ITS CONTAINER AND THE CONFORMANCE RUN — RAN 2026-09-24** *(which sitting is next: the plan's sittings table, and ORIENTATION §7e)*
