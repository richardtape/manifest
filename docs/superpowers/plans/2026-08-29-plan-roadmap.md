...
sitting 1 — Tasks 1 and 2 — is done, and SITTING 2 (Task 3, alone) IS THE CURRENT WORK.**
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   2026-09-09 — and P4b is PART-EXECUTED: sitting 1 (Tasks 1–2) done 2026-09-09,
   14 tasks remaining. Continue P4b at Task 3.**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   2026-09-09.** ← **P4b IS NOW THE CURRENT WORK, AT TASK 3** (sitting 1 done
   2026-09-09).
