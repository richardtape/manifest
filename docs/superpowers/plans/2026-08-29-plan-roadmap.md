...
all 16 tasks, finished 2026-09-15. P4c — zero-downtime redeploys — IS WRITTEN (2026-09-15) AND BEING EXECUTED: 11 tasks in eight agreed sittings, SITTINGS 1, 2 AND 3 ARE DONE (2026-09-15; 13 findings, 4 and 7) and SITTING 4 (TASK 5) IS NEXT.**
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   WRITTEN and being executed — sittings 1 and 2 done, 2026-09-15 (step 7).**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   **P4b was then written on 2026-09-07 as well, at Rich's request** —
   ...
   11 tasks in eight agreed sittings, AND BEING EXECUTED: sittings 1 and 2 are done
   (2026-09-15; 13 findings and 4 — the acceptance built and watched failing, with the
   baseline it is judged against, then §11's redeploy contract in code), and sitting 3
   is next.** It waited for P4b to execute, because P4b's Tasks 8–15 were changing the deploy
