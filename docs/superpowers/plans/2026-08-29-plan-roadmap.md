...
| **P4a** | 1b-i | Identity, secrets & the §8 contract — **PART-EXECUTED 2026-09-08: Tasks 1–5 of 15 are done and green. Tasks 6–15 remain.** A real CWL login works end to end, and `secrets/` holds every service credential | the proof app signing in with CWL and writing a note, via `curl` |
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   ran as its Task 18 and has reported. **P4a is part-executed — Tasks 1–5 of 15
   done 2026-09-08 — and P4b is written and unrun. 28 tasks of written work remain.
   Continue P4a at Task 6.**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   remain.** ← **CONTINUING P4a AT TASK 6 IS THE CURRENT WORK.**
   **P4b was then written on 2026-09-07 as well, at Rich's request** —
   ...
   the second plan early. **The unexecuted stack is now 26 tasks** — P4a's remaining 10 and
