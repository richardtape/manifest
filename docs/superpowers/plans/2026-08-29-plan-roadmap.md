...
| **P6–P11** | 2 | **SEVEN plans since 2026-09-19, listed below** — P6 split into P6a and P6b on D9's own two clauses — **P6a IS WRITTEN AND EXECUTING — most recently sitting 4, Tasks 5 and 6, on 2026-09-20 with 19 findings; HOW MANY SITTINGS ARE DONE is stated in the P6a row below and in the plan's own sittings table, and deliberately not here. P6a IS BRIEFED** ([`2026-09-19-p6-brief.md`](./2026-09-19-p6-brief.md)), which records the three decisions Rich made that day and sizes the whole of P6 at 18–24 tasks | P6a: an app reaches production with every blocking item honestly met |
...
| P6a Tasks 5–6 (sitting 4, migration 0019 and the two external records) | 2 | 19 | 9.5 |
| **P6a, in flight** | **6 of 19** | **57** | **9.5** |
