...
all 16 tasks, finished 2026-09-15. P4c — zero-downtime redeploys — IS WRITTEN (2026-09-15): 11 tasks in eight agreed sittings, and SITTING 1 IS NEXT.**
...
5. **Execute P1 → P2 → P3.** ✅ **All three are done.** P1 and P2 executed and green
   ...
   WRITTEN and waiting to be executed (step 7).**
...
7. **Write P4 once P3 has executed**, and P5 when P4 lands. **P4 was split into P4a
   ...
   **P4b was then written on 2026-09-07 as well, at Rich's request** —
   ...
   11 tasks in eight agreed sittings, AND WAITING TO BE EXECUTED.** It waited for P4b to execute, because P4b's Tasks 8–15 were changing the deploy
