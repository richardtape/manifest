...
redeploys — IS WRITTEN (2026-09-15) AND IS BEING EXECUTED: sittings 1 AND 2 ARE DONE
(2026-09-15; 13 findings and 4), and SITTING 3 IS NEXT (§7d-3).** This is the single
...
2026-09-09, with 10 findings, sitting 2 (Task 3) on 2026-09-14, with 6, sitting 3 (Tasks 4–5) the same day, with 11, sitting 4 (Tasks 6–7) the same day, with 12, sitting 5 (Tasks 8–9) the same day, with 11, sitting 6 (Task 10) the same day, with 14, sitting 7 (Tasks 11–12) the same day, with 16, sitting 8 (Task 13) on 2026-09-15, with 20, sitting 9 (Tasks 14–15) the same day, with 18, and sitting 10 (Task 16) the same day, with 22 — 140 in all. P4c IS WRITTEN AND BEING EXECUTED — SITTINGS 1 AND 2 ARE DONE, 2026-09-15, WITH 13 FINDINGS AND 4**
...
| | |
|---|---|
| `pnpm test` (from the **repo root**) | **775 passed, 67 files**, ~45 s, no Docker needed except Postgres for the `db/`, `api/`, `secrets/`, `services/`, `sso/`, `observability/` and `releases/` suites — plus **`spec/injection-drift`**, which reads the pinned `passport-ubcshib` tarball out of the platform's own mirror. It connects as **`manifest_app`**, not as `manifest` — see §7d |
| `pnpm test:docker` | **144 passed and 11 SKIPPED**, 26 files, ~525 s. The eleven are the driver contract's continuity block, which the Docker driver has no fixtures for until P4c Task 5 — it is skipped **with the reason in its name**, never silently. Needs `make up`, and **fails rather than skips** when asked to run |
...
│                                                  SITTINGS 1-2 DONE 2026-09-15,
│                                                  13 findings and 4. Its brief,
...
## 7. What to do next — execute P4c, ONE SITTING AT A TIME (sittings 1–3 are done; sitting 4 is next)
...
pin on 2026-09-09, sitting 2 ran Task 3, sitting 3 ran Tasks 4–5, sitting 4 ran Tasks 6–7, sitting 5 ran Tasks 8–9, sitting 6 ran Task 10 and sitting 7 ran Tasks 11–12, all on 2026-09-14, sitting 8 ran Task 13, sitting 9 ran Tasks 14–15 and sitting 10 ran Task 16, all on 2026-09-15**, so P4b is finished and P4c — §7d-3 — is WRITTEN (2026-09-15) and being executed: **sittings 1, 2 and 3 are done (2026-09-15, 13 findings, 4 and 7), sitting 4 is next, and the plan runs one sitting per session** exactly as P4a's seven and P4b's ten did. **P4b ran in ten agreed sittings**,
...
**WRITTEN 2026-09-15 AND BEING EXECUTED: [`plans/2026-09-15-p4c-zero-downtime-redeploys.md`](plans/2026-09-15-p4c-zero-downtime-redeploys.md) — 11 tasks in EIGHT AGREED SITTINGS, ONE PER SESSION. SITTINGS 1, 2 AND 3 ARE DONE (2026-09-15; 13 findings, 4 and 7). SITTING 4 IS NEXT, AND IT IS TASK 5.**
...
**What sittings 1, 2 and 3 did, and what sitting 4 inherits.**
...
Docker driver** — it is still skipped for that driver, with its reason in its name, and those four
methods still throw `DRIVER_UNSUPPORTED`. Read the **three corrections at the top of Task 5**
before you start; one of them (the `neverReady` fixture) is in code the task tells you to write.
**Nothing removes the old container yet**, so a redeploy after sitting 3 leaves two — that backlog
is Task 5's to reap. **`pnpm test:docker` is part of every sitting's close-out from here on**, and
sitting 3 found a defect that only the FULL run could see.
