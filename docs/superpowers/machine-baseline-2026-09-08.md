...
codercom-coder-1	ghcr.io/coder/coder:latest	Exited (0) 10 days ago
codercom-database-1	postgres:17	Exited (0) 10 days ago
...
credit-card-helper-app-1	credit-card-helper-app	Exited (0) 11 days ago
credit-card-helper-frontend-1	node:20-alpine	Exited (0) 11 days ago
...
manifest-caddy	manifest-caddy:local	Up 23 minutes (healthy)
manifest-dns-containers	manifest-dnsmasq:local	Up 32 hours
manifest-dns-host	manifest-dnsmasq:local	Up 32 hours
manifest-egress	manifest-egress:local	Up 32 hours
manifest-idp	manifest-idp:local	Up 3 hours
manifest-litellm	ghcr.io/berriai/litellm:main-stable	Up 32 hours (healthy)
manifest-postgres	postgres:16-alpine	Up 32 hours (healthy)
manifest-registry	registry:2	Up 32 hours (healthy)
manifest-verdaccio	verdaccio/verdaccio:6	Up 32 hours (healthy)
...
manifest-idp:local	sha256:700194d4fb6a0ac4a4f108c4b29663782a9a8b0c3b79cdf1325f3045d1a13056
...
=== Repository ===
branch      main
HEAD        0fb8779 docs(p4a): record Session 2b — the route fix and §8's missing file mechanism
dirty       9 file(s)
