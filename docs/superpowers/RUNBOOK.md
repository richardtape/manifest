...
(re-measured 2026-09-18 at the end of **P5c sitting 3**, **in both of the two machine states that now exist — the reference console running on 7104, and 7104 free** — and unchanged since P5a sitting 11. The unit tier is **1354 tests in 103 files** as of that sitting, and `pnpm test:docker` is **178 in 29 files**, RE-measured by sitting 3 in 807 s because it changed `infra/caddy/Caddyfile`.) ORIENTATION §2's box is the maintained copy of those; if this
