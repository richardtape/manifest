...
sittings 1 to 7 of ten (Tasks 1–12) are done, 2026-09-14; CONTINUE AT TASK 13** —
...
implementation plans are executed**. **P4a is executed in full; P4b is part-executed — 12 of 16
...
is also why P4b's unrun stack — 4 of its 16 tasks — is worth naming out loud rather than glossing. The maintained status record is the *Spike status*
