...
sittings 1 to 9 of ten (Tasks 1–15) are done, 2026-09-15; CONTINUE AT TASK 16** —
...
implementation plans are executed**. **P4a is executed in full; P4b is part-executed — 15 of 16
...
is also why P4b's unrun stack — 1 of its 16 tasks — is worth naming out loud rather than glossing. The maintained status record is the *Spike status*
