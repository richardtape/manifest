...
sittings 1 to 8 of ten (Tasks 1–13) are done, 2026-09-15; CONTINUE AT TASK 14** —
...
implementation plans are executed**. **P4a is executed in full; P4b is part-executed — 13 of 16
...
is also why P4b's unrun stack — 3 of its 16 tasks — is worth naming out loud rather than glossing. The maintained status record is the *Spike status*
